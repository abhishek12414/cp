...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User shipping/billing addresses for checkout';
    displayName: 'Address';
...
export interface ApiAttributeAttribute extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable dynamic attributes associated with product types/categories (e.g., wattage, voltage, color, brand). Supports type-specific attrs without hardcoding in Product.';
  ...
  attributes: {
    ...
    fieldType: Schema.Attribute.Enumeration<
      ['string', 'number', 'boolean', 'select', 'text']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'string'>;
    isFilterable: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    productAttributeValues: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Brand details for products (one brand per product, many products per brand). Integrates with existing scalable Product/EAV schema.';
    displayName: 'Brand';
    pluralName: 'brands';
    singularName: 'brand';
  };
...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Items in cart: links product (and thus brand) with quantity. Supports adding products to cart.';
...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "User's shopping cart, linked to products via CartItems for quantities. Ties into Product/Brand for e-com.";
    displayName: 'Cart';
    pluralName: 'carts';
    singularName: 'cart';
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product categories/types (e.g., Bulb, Wire, Switches) to support scalability. Attributes are associated at the type level for consistent dynamic attrs per product type.';
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Snapshot of ordered products (with qty, price at purchase); links to Product/Brand for order history.';
...
export interface ApiProductAttributeValueProductAttributeValue
  ...
  info: {
    description: "EAV join table for dynamic attribute values per product, tied to category's attributes. Enables type-specific attrs (e.g., Bulb.wattage=10W) without schema changes.";
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Scalable Product model with common fields (incl. brand relation) + EAV dynamic attributes tied to category's attributes. Attributes associated at product type level for consistency; no hardcoded category-specific fields. Each product belongs to one brand.";
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiUploadOrderUploadOrder extends Struct.CollectionTypeSchema {
  collectionName: 'upload_orders';
  info: {
    description: 'User uploaded files (from electrician) for manual billing generation';
    displayName: 'Upload Order';
    pluralName: 'upload-orders';
    singularName: 'upload-order';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    files: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    generatedOrder: Schema.Attribute.Relation<'oneToOne', 'api::order.order'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserActivityUserActivity
  ...
  info: {
    description: 'Tracks user search history and product interactions for personalization';
...
export interface ApiWishlistWishlist extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "User's wishlist items linked to products";
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uploadOrders: Schema.Attribute.Relation<
      'oneToMany',
      'api::upload-order.upload-order'
    >;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::upload-order.upload-order': ApiUploadOrderUploadOrder;
